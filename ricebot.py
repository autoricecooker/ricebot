...
def handle(msg):
    ...
    if content_type == "text":
        ...
        #elif ((msg["text"] == "/startgame@werewolfbot") or (msg["text"] == "/nextgame@werewolfbot")) and (chat_id == ""):
            #ricebot.sendMessage(chat_id, "Hi, you may join this GC's werewolf game channel at " + wwgc, parse_mode="Markdown", disable_web_page_preview=None, disable_notification=True, reply_to_message_id=msg_id)
